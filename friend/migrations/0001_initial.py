...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Friend'
        db.create_table('friend_friend', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['auth.User'])),
            ('to_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_user_friends', to=orm['auth.User'])),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('friend', ['Friend'])


    def backwards(self, orm):
        # Deleting model 'Friend'
        db.delete_table('friend_friend')
    ...
    models = {
        ...
        'friend.friend': {
            ...
            'to_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to_user_friends'", 'to': "orm['auth.User']"})
        }
    }
