...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('groups_group', (
            ...
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='my_own_groups', to=orm['auth.User'])),
        ...
        db.create_unique('groups_group_users', ['group_id', 'user_id'])
