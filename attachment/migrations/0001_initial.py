...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Media'
        db.create_table('attachment_media', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('link', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('attach_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['attachment.Attachment'])),
        ))
        db.send_create_signal('attachment', ['Media'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('attachment_media')
    ...
    models = {
        ...
        'attachment.media': {
            ...
            'attach_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['attachment.Attachment']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
